...
La ruta de proyecto nuevo de esta guía escribe el prototipo en `~/mi-prototipo/`. Si el agente reportó una subcarpeta `prototype/` porque encontró un proyecto existente, usa esa ruta reportada.
