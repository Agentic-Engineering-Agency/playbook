---
title: Prototype Kit
description: Construye un prototipo pulido con React + shadcn en una tarde. Sin escribir código.
---

# Construye un prototipo pulido en una tarde. Sin escribir código.
