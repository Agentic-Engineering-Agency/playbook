...
The five cards above link to the playbook chapters. The [full skills catalog](/docs/pm-kit/07-reference) and the [BookSwap Campus worked example](/cases/bookswap-campus) are available as companion pages.
