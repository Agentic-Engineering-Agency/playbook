...
The `agentic-pm-kit` package is public on npm and the command below matches its canonical README.
...
The `@specsafe/cli` package is public on npm and the command matches the canonical repository.
